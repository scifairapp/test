...
if __name__ == '__main__':
    ...
    Best_Renewable_Resource = {
        'low_temp_(f)': [35, 28, 39, 44, 50, 45, 56, 38, 37, 50, 40, 66, 63, 44, 60, 35, 36, 42, 39, 35, 43, 60, 36, 42,
                         48,
                         44, 52, 44, 32],
        'high_temp_(f)': [53, 56, 58, 59, 67, 58, 75, 55, 56, 64, 60, 36, 80, 64, 78, 60, 50, 64, 60, 57, 66, 78, 59,
                          62,
                          71, 64, 76, 62, 54],
        'precipitation_(in)': [44.85, 24.93, 39.35, 43.56, 39.74, 34.1, 49.76, 9.3, 36.82, 23.64, 42.94, 9.67, 54.69,
                               47,
                               52.71, 12.52, 29.13, 53.4, 37.77, 13.3, 44.75, 45.28, 34.66, 2.15, 54.37, 42.64, 53,
                               41.5,
                               24.31],
        ...
        'cloudy_(percentage)': [50.75, 39.33, 49, 47.58, 44.75, 52.83, 44.42, 47.25, 49.75, 33.75, 46.67, 34.58, 46.75,
                                55.16, 46.83, 41.25, 54.92, 43.16, 48.67, 50.33, 42.33, 40.58, 42.92, 40.91, 42.42,
                                43.5,
                                43.58, 46.5, 44.58],
        'snowy_(in)': [38.4, 14.91, 59, 38.5, 15, 0.24, 0.1, 4.58, 81, 0, 37, 1.73, 0, 3, 0, 75, 119, 0.62, 16.4, 1.69,
                       14,
                       0, 23, 0.99, 2, 1, 0.1, 2.04, 33],
        'best_renewable_resource': [1, 2, 1, 3, 2, 1, 2, 1, 2, 2, 1, 2, 3, 1, 3, 2, 4, 1, 1, 1, 2, 2, 1, 1, 1, 2, 1, 1,
                                    1],
    }

    df = pd.DataFrame(Best_Renewable_Resource,
                      columns=['low_temp_(f)', 'high_temp_(f)', 'precipitation_(in)', 'wind_speed_(mph)',
                               'humidity_(d)',
